...
const pages = ['Productos', 'Tienda', 'Novedades', 'Compras', 'Accesorios'];
            ...
            <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
              {pages.map((page) => (
                <Button
                  ...
                  sx={{ my: 2, color: '#fff', display: 'block', fontSize: '16px', fontWeight:'Bold' }}
                >
                  {page}
                </Button>
              ))}
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Open settings">
                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                  <Avatar alt="Erica" src="navImage.jpg" />
                </IconButton>
              </Tooltip>
              <Menu
                sx={{ mt: '45px' }}
